...
navigator.mediaDevices.getUserMedia({ video: true }).then((stream) => {
    ...
    const videoGeometry = new THREE.PlaneGeometry(16, 9); // 비율에 맞게 조절
...
// // Create a cube with a video texture
// const geometry = new THREE.BoxGeometry();
// const material = new THREE.MeshBasicMaterial({ map: createWebcamTexture() });
// const cube = new THREE.Mesh(geometry, material);
// scene.add(cube);
...
//     if (cube.material.map && cube.material.map.image instanceof HTMLVideoElement) {
